		<header>
			...
			<br>
			<h2>PHP7 MVC Version</h2>
			<br>
			<h4><a href="<?php echo BASE_URL; ?>prototypes">Prototypes Version</a></h4>
			<h4><a href="<?php echo BASE_URL; ?>objects">Objects Version</a><h4>
		</header>

		<div class="div_home">

			<form method="POST" action="<?php echo BASE_URL; ?>registered">
				...
				<fieldset id="fieldset_education">
					...
					<input type="radio" name="schooling" value="Incomplete High School" id="incompleteHighSchool" onclick="FieldsetEducation.hiddenEducationDiv()">  Incomplete High School <br>

					<input type="radio" name="schooling" value="Complete High School" id="completeHighSchool" onclick="FieldsetEducation.hiddenEducationDiv()">  Complete High School<br>

					<input type="radio" name="schooling" value="Incomplete University" onclick="FieldsetEducation.showEducationDiv()">  Incomplete University<br>

					<input type="radio" name="schooling" value="Studying at University" onclick="FieldsetEducation.showEducationDiv()">  Studying at University<br>

					<input type="radio" name="schooling" value="Complete University" onclick="FieldsetEducation.showEducationDiv()">  Complete University Degree<br>

					<input type="radio" name="schooling" value="Complete Master Degree" onclick="FieldsetEducation.showEducationDiv()">  Complete Master Degree</option><br>

					<input type="radio" name="schooling" value="Doctorate Degree" onclick="FieldsetEducation.showEducationDiv()">  Doctorate Degree
				...
				<fieldset id="fieldset_professional_experience">
					...
					<input type="radio" name="hasExperience" value="Has Professional Experience" id="hasExperience" onclick="FieldsetProfessional.showButtonAddProfessionalExperience()"> Has Professional Experience
					
					<input type="radio" name="hasExperience" value="Doesn't Has Professional Experience" onclick="FieldsetProfessional.hiddenButtonAddProfessionalExperience()" id="doesNotHasExperience" checked> Doesn't Has Professional Experience

					<div id="button_add_professional_exp" hidden>
						<br><br>
						<input onclick="FieldsetProfessional.showDivAddExperienceData()" type="button" value="Add Professional Experience"></input>
					</div>
					...
					<div id="div_has_professional_exp" hidden>
						...
						<br><br>
						<input type="submit" onclick="FieldsetProfessional.hiddenCompanyExperience()" value="Delete This Experience">
				...
				<input type="submit" class="button-app-main-page" value="Register with PHP and MySQL">
			
			</form>
	
			<button onclick="ValidateCurriculumForms.verifyCurriculumForms()" class="button-app-main-page">Verify Forms JavaScript</button>

			<div id="div_data_send"></div>

			<br>
	        <h2 style="text-align: center;"><a href="<?php echo BASE_URL?>registered">See Data Base</a></h2>
			
			<br>
	        <h4 style="text-align: center;"><a target="_blank" href="<?php echo BASE_URL; ?>assets/js/classes.js">See ECMAScript6+ Classes Code</a></h4>
	        <br>