 ...
 * ICMC USP 2018
 *
 * Esse arquivo utiliza o JavaScript com OBJECT NATIVES
 *
...
-->		
		<header>
			...
			<br>
			<h2>Objects Version</h2>
			<br>
			<h4><a href="<?php echo BASE_URL; ?>">Classes Version</a></h4>
			<h4><a href="<?php echo BASE_URL; ?>prototypes">Prototypes</a><h4>
		    <br>
		</header>
		...
		<div class="div_home">
				...
				<fieldset id="fieldset_professional_experience">
					...
					<div id="div_has_professional_exp" hidden>
						...
						<input type="radio" value="Technology" name="businessSegment">  Technology <br>
						<input type="radio" value="Human Resources" name="businessSegment">  Human Resources <br>
						<input type="radio" value="Retail of Physical Products" name="businessSegment">  Retail of Physical Products <br>
						<input type="radio" value="Digital Marketing" name="businessSegment">  Digital Marketing <br>
                ...
                <h4 style="text-align: center;"><a target="_blank" href="<?php echo BASE_URL; ?>assets/js/objects.js">See JavaScript Objects Code</a></h4>
		        <br>
		...
		<script type="text/javascript" src="<?php echo BASE_URL; ?>assets/js/objects.js"></script>
